...
# Hiển thị tiêu đề lớn
    """
     <span style='font-size:24px; font-weight:bold;'>📝 Sửa, Xóa hồ sơ Tuyển sinh</span><br>
    """,
...
def update_dialog():
    ...
    if selected_row is not None:
        for col in df.columns:
            st.session_state[col] = selected_row[col]
        st.info("Dữ liệu đã được load lên các widget, bạn có thể sửa và lưu lại.")
