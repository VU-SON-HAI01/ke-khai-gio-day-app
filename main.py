...
if st.session_state.token is None:
    ...
    def main_page():
        """Hàm này render nội dung cho trang chính của hệ thống."""
    ...
    if user_email == ADMIN_EMAIL:
        ...
        # Cập nhật menu cho Admin theo file main.py mới nhất
        pages = {
        ...
        # SỬA LỖI: Trang "Kê giờ dạy" được gọi qua st.Page thay vì file chính
        pages = {
            "Trang chủ": [st.Page(main_page, title="Trang chủ", icon="🏠")],
