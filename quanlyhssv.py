...
with col3:
    ...
    def show_review_dialog():
        ...
        split = n // 2 + (n % 2)
        style_macdinh = "font-weight:normal;margin-bottom:2px;display:inline"
        style_xanh = "color:green;font-weight:normal;display:inline;margin-bottom:2px"
        style_cam = "color:Orange;font-weight:normal;display:inline;margin-bottom:2px"
        style_do = "color:Red;font-weight:normal;display:inline;margin-bottom:2px"
