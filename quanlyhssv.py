...
with col3:
    ...
    if trinh_do == "Cao đẳng" or trinh_do == "Liên thông CĐ":
        ...
        trinhdo_totnghiep = st.radio(":green[TRÌNH ĐỘ TỐT NGHIỆP]", ["THPT","Cao đẳng, Trung cấp","Khác"], horizontal=True, index=["THPT","Cao đẳng, TC","Khác"].index(st.session_state.get("trinhdo_totnghiep", "THPT")))
