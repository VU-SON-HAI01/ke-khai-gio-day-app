...
def display_class_schedule(df_data, client, spreadsheet_id):
    ...
    if selected_class:
        ...
        # Hiển thị thông tin chung của lớp (giữ nguyên từ file gốc)
        ...
        # Gọi hàm render chi tiết, hàm này sẽ tự động hiển thị GVBM vì mode='class'
